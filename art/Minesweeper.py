...
from tealight.art import (color, line, spot, circle, box, font, image, text, background)
...
def DrawFlag(x,y):
  ...
  x += 0.5
  y += 0.5
  box(StartingX + SquareSize * x,StartingY + SquareSize * y, SquareSize/3,SquareSize/2.5)
